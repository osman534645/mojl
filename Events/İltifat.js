...
let iltifatlar = [
  ...
  "Üşüdüysen sana abayı yakabilirim.",
  "Ateşimin çıkma sebebi corona değil, sensin.",
  "İban at hayallerimi yollayayım harcarsın.",
  "Sevgilim var yazma?",
  "Bi alo de gelmezsem gençliğim solsun.",
  "Konum at da belamızı bulalım bebeğim.",
  "Kakaolu sütsün seni sevmeyen ölsün."
];

module.exports = (message) => {
    if(message.channel.id !== "756662746002751500" || message.author.bot) return; {
    iltifatSayi++;
    if (iltifatSayi >= 50) {
      iltifatSayi = 0;
